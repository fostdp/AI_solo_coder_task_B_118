...
impl InteractiveExperience {
    ...
    pub fn apply_bellows_action(
        ...
        session.phase = LESSONS[phase_idx].phase.to_string();
        session.lesson_text = lesson.to_string();
...
mod tests {
    ...
    fn test_add_fuel() {
        ...
        let response = exp
            .add_fuel(session.session_id, crate::models::FuelType::Coal, 20.0)
            .unwrap();
    ...
    #[test]
    fn test_lessons_and_achievements() {
